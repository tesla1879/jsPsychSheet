...
tags$script(src='jspsych-6.3.1/plugins/jspsych-image-keyboard-response.js'),
tags$script(src='jspsych-6.3.1/plugins/jspsych-preload.js'),
...
```{js}
  ...
  var instructions = {
    ...
    stimulus: "<p>In this experiment, a circle will appear in the center " +
              ...
              "<div class='float: right;'><img src='jspsych-6.3.1/examples/img/orange.png'></img>" +
